...
class Tela:
    def __init__(self, master):
        ...
        self.cbx_semana = ttk.Combobox(self.janela, values=valores, state='read', textvariable=self.dia)
    ...
    def enviar(self):
        messagebox.showinfo('Informação', f'A prova vai ser na: {self.dia.get()}')
